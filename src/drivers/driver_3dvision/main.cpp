...
static FieldBuilder tokenParam() {
    return FieldBuilder("token", FieldType::String).description("认证令牌 (从登录接口获取)");
}
        ...
        DriverMetaBuilder()
            ...
            .command(
                CommandBuilder("login")
                    ...
                    .param(FieldBuilder("userName", FieldType::String)
                               ...
                               .description("用户名"))
                    .param(
                        FieldBuilder("password", FieldType::String).required().description("密码"))
            ...
            .command(
                CommandBuilder("vessel.exists")
                    ...
                    .param(addrParam())
                    .param(
                        FieldBuilder("name", FieldType::String).required().description("料仓名称"))
            ...
            .command(
                CommandBuilder("vessel.command")
                    ...
                    .param(FieldBuilder("cmd", FieldType::String)
                               .required()
                               .description("命令类型: "
                                            "scan(扫描)/crane_pull_in(起重机收回)/"
                                            "crane_push_out(起重机伸出)/get_vessel_info(获取信息)"))
            ...
            .command(
                CommandBuilder("vessellog.list")
                    ...
                    .param(FieldBuilder("count", FieldType::Int)
                               ...
                               .description("返回数量限制"))
                    .param(
                        FieldBuilder("offset", FieldType::Int).required().description("分页偏移量"))
                    .param(FieldBuilder("desc", FieldType::Bool)
                               .defaultValue(true)
                               .description("是否降序排列 (true=最新的在前)"))
            ...
            .command(
                CommandBuilder("material.get")
                    ...
                    .param(addrParam())
                    .param(
                        FieldBuilder("name", FieldType::String).required().description("物料名称"))
            ...
            .command(
                CommandBuilder("material.add")
                    ...
                    .param(FieldBuilder("densityType", FieldType::String)
                               .description(
                                   "密度类型: "
                                   "LevelDensityTable(液位密度表)/VolumeDensityTable(体积密度表)"))
            ...
            .command(CommandBuilder("filter.replace")
                         ...
                         .param(FieldBuilder("predefined", FieldType::Bool)
                                    .required()
                                    .description("是否为预定义滤波器"))
                         .param(FieldBuilder("content", FieldType::String)
                                    .required()
                                    .description("滤波器配置内容 (JSON字符串)"))
                         .returns(FieldType::Object, "成功时返回空对象"))
            ...
            .command(
                CommandBuilder("custommodel.upload")
                    ...
                    .param(addrParam())
                    .param(
                        FieldBuilder("name", FieldType::String).required().description("模型名称"))
                    .param(FieldBuilder("data", FieldType::String)
                               .required()
            ...
            .command(
                CommandBuilder("ws.unsubscribe")
                    ...
                    .group("WebSocket")
                    .param(
                        FieldBuilder("topic", FieldType::String).required().description("主题名称"))
