...
if(EXISTS "${CURRENT_PACKAGES_DIR}/usr/local")
    file(GLOB GPERF_USR_LOCAL_CONTENT LIST_DIRECTORIES true "${CURRENT_PACKAGES_DIR}/usr/local/*")
    if(GPERF_USR_LOCAL_CONTENT)
        file(COPY ${GPERF_USR_LOCAL_CONTENT} DESTINATION "${CURRENT_PACKAGES_DIR}")
    endif()
