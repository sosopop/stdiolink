...
foreach(_pc_file
    "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libcap.pc"
    "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/libpsx.pc"
    "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libcap.pc"
    "${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/libpsx.pc")
    if(EXISTS "${_pc_file}")
        vcpkg_replace_string("${_pc_file}" "exec_prefix=" "exec_prefix=\${prefix}")
        vcpkg_replace_string("${_pc_file}" "libdir=/lib" "libdir=\${exec_prefix}/lib")
        vcpkg_replace_string("${_pc_file}" "includedir=/include" "includedir=\${prefix}/include")
    endif()
endforeach()
