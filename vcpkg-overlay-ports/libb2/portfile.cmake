...
if(EXISTS "${CURRENT_PACKAGES_DIR}/usr/local")
    file(GLOB LIBB2_USR_LOCAL_CONTENT LIST_DIRECTORIES true "${CURRENT_PACKAGES_DIR}/usr/local/*")
    if(LIBB2_USR_LOCAL_CONTENT)
        file(COPY ${LIBB2_USR_LOCAL_CONTENT} DESTINATION "${CURRENT_PACKAGES_DIR}")
    endif()
